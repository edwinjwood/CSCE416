 ...
 * It also receives messages from the server and displays them
 */
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            while (true) {
                ...
                String lineToServer = fromUserReader.readLine();

                // If we get null, it means user is done
                if (lineToServer == null) {
                    System.out.println("Closing connection");
                    break;
                }

                // Send the line to the server
                toServerWriter.println(clientName + ": " + lineToServer);

                // Read a message from the server
                String messageFromServer = fromServerReader.readLine();
